...
import LoginImg from "@/assets/clout-africa.jpg"
          ...
          <form className="p-6 md:p-8" onSubmit={handleSubmit}>
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-balance text-muted-foreground flex">
                  Login to your &nbsp; <span className="w-16 mt-1"><img src={theme === 'light'? DarkLogo : LightLogo} alt="starvoxx"/> </span> &nbsp;account
                </p>
              </div>
